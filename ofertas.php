<?php
session_start();
include('bd.php');//Esto lo iba a usar para hacer una especie de reloj que fuera cambiando los productos en descuento de la pagina para que no fueran los mismos nunca
?>      
<!DOCTYPE html>
<html lang="es">
<head>
...
<header>
    ...
    <div class="products">
        <?php
        $sql = "SELECT * FROM productos WHERE en_oferta = 1";
